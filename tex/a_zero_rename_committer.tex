...
\label{sec:integrationWithHadoopAndSpark}
...
which write to Hadoop filesystems, the `FileOutputFormat`, so that rather than
returning the standard `FileOutputCommitter`, it was possible to declare
