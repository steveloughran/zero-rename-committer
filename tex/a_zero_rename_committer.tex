...
This new process creates an instance of the specified Job Committer,
...
``Job History'' file;
a log of the events saved during the execution.
This history records all tasks which successfully committed, and which could
...
to have scaleablity problems for jobs with tens of thousands of files \cite{MAPREDUCE-4815}.
...
This is again a few hundred milliseconds per file, though parallelisation
...
The committer believes that it tasks are
 writing files to a temporary destination and renaming them, when
