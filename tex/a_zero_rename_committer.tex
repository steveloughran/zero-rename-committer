...
An incomplete UML sequence diagram of the commit protocol is
...
\subsubsection{Hadoops FileOutputCommitter}
...
each of which can execute runs a number of threads
