...
Task commit is a non-atomic recursive treewalk-and-rename operation.
...
The Spark commit protocol does permit task committers to return data to
...
\subsection{The Magic Committer}\label{subsec:magiccommitter}
